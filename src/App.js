...
import UserHistoryLists from './component/UserHistoryLists'
...
class HistoryListsApp extends Component {
  state = {
    searchInput: '',
            ...
            <ul className="history-lists">
              {searchResults.map(each => (
                <UserHistoryLists
                  historyDetails={each}
                  key={each.id}
                  onDeleteHistoryItems={this.onDeleteHistorySearch}
                />
              ))}
            </ul>
          ) : (
...
export default HistoryListsApp
